...
class CadastroGoogle extends StatefulWidget {
  @override
  _CadastroGoogleState createState() => _CadastroGoogleState();
}

class _CadastroGoogleState extends State<CadastroGoogle> {
